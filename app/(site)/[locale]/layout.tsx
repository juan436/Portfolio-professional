...
// `generateStaticParams: []` + `dynamicParams: true` = ISR on-demand: nada se
// prerenderea en el build (que corre sin Mongo), la 1ª visita a cada ruta la
// genera con datos reales y la cachea; `revalidate` la refresca cada hora.
// Locales inválidos → `notFound()` en el cuerpo del layout.
