  ...
  return (
    <g>
      ...
      <g>
        ...
        <motion.rect
          initial={{ x: "45", y: "34", width: "6", height: "2" }}
          fill="white"
          animate={{ x: [45, 47, 45] }}
          transition={{ repeat: Number.POSITIVE_INFINITY, duration: 1.5 }}
        />
        <motion.rect
          initial={{ x: "59", y: "34", width: "6", height: "2" }}
          fill="white"
          animate={{ x: [59, 61, 59] }}
          transition={{ repeat: Number.POSITIVE_INFINITY, duration: 1.5 }}
        />
        ...
        <motion.rect
          initial={{ x: "25", y: "70", width: "5", height: "8" }}
          rx="1"
          fill="#3B82F6"
        ...
        />
        <motion.path
          initial={{ d: "M80,74 L85,74 M82.5,71.5 L82.5,76.5" }}
          stroke="#3B82F6"
          strokeWidth="2"
        ...
        >
          <motion.rect
            initial={{ x: "90", y: "30", width: "10", height: "6" }}
            fill="#3B82F6"
            rx="2"
          ...
          />
          <motion.circle
            initial={{ cx: "90", cy: "60", r: "4" }}
            fill="#3B82F6"
            animate={{ scale: [1, 1.2, 1] }}
            transition={{ repeat: Number.POSITIVE_INFINITY, duration: 1.5 }}
          />
          <motion.path
            initial={{ d: "M20,40 L15,45 L25,45 Z" }}
            fill="#3B82F6"
            animate={{ rotate: [0, 15, 0, -15, 0] }}
            transition={{ repeat: Number.POSITIVE_INFINITY, duration: 2 }}
            originX="20"
