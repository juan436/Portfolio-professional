...
// Local por defecto (mismo criterio que export-content-dump.mjs); en el
// contenedor de prod se pasa por `--env-file .env`.
const URI = process.env.MONGODB_URI || "mongodb://localhost:27017/portfolioNew"

const now = new Date()
const at = (iso) => new Date(iso)

// _id de los proyectos (mismos en local y prod — el dump preserva _id)
